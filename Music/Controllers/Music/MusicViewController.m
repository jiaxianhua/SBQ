...
- (void)changeIndex {
    ...
    NSString *htmlFileName = [NSString stringWithFormat:@"%@%02ld", name, (long)self.musicEntity.musicId.integerValue];
...
- (void)createStreamer {
    ...
    [self setupMusicViewWithMusicEntity:musicEntity];
